...
If you like this project, please leave us a __Star__ on the project 😎
...
3. Create a branch locally with a succinct but descriptive name (`git checkout -b feature/AmazingFeature`)
4. Commit changes to the branch with a descriptive title (`git commit -m 'Add some AmazingFeature'`)
5. Following any formatting and testing guidelines specific to this repo
6. Push changes to your forked repository branch (`git push origin feature/AmazingFeature`)
